...
if [ "${FRP_VERSION}" = "" ] ; then
  FRP_VERSION="$(curl -sL https://github.com/kirilngusi/go-reverse-proxy/releases | \
...
URL="https://github.com/kirilngusi/go-reverse-proxy/releases/download/v${FRP_VERSION}/${NAME}"
